...
// Wait for measurement complete
	...
	// Set power level value
	status = viPrintf(rsrc, (ViString)"SOURce:POWer -20\n");
	...
	// Save data
	status = viPrintf(rsrc, (ViString)":CALCulate:DATA:SNP:SAVE \"E:\\MicranStart\\kalls_20.s2p\"\n");
