...
int main()
{
	...
	//status = viPrintf(rsrc, ":MMEMory:LOAD:CORRection \"C:\\Work\\calib.r4mc\"\n");
	// Set correction enabled
	//status = viPrintf(rsrc, ":SENSe:CORRection ON\n");
	// Set RBW
	...
	// Save profile
	//status = viPrintf(rsrc, ":MMEMory:STORe:STATe \"d:\\calib.gpr\"\n");
	// Check errors
	//status = viQueryf(rsrc, "SYSTem:ERRor?\n", "%T", buff);
	//printf("Error: %s\r\n", buff);	
